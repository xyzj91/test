...
--
-- Host: localhost
-- Generation Time: 2016-10-24 23:15:28
-- 服务器版本： 5.5.35
-- PHP Version: 5.5.7
...
CREATE TABLE IF NOT EXISTS `star_action` (
...
INSERT INTO `star_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
...
--
-- 表的结构 `star_action_log`
--

CREATE TABLE IF NOT EXISTS `star_action_log` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=49 ;

--
-- 转存表中的数据 `star_action_log`
--

INSERT INTO `star_action_log` (`id`, `action_id`, `user_id`, `action_ip`, `model`, `record_id`, `remark`, `status`, `create_time`) VALUES
(44, 1, 1, 2130706433, 'member', 1, 'admin在2016-10-17 22:47登录了后台', 1, 1476715678),
(43, 1, 1, 2130706433, 'member', 1, 'admin在2016-10-17 22:29登录了后台', 1, 1476714590),
(42, 1, 1, 2130706433, 'member', 1, 'admin在2016-10-17 22:26登录了后台', 1, 1476714372),
(41, 1, 1, 2130706433, 'member', 1, 'admin在2016-10-17 22:15登录了后台', 1, 1476713748),
(45, 1, 1, 2130706433, 'member', 1, 'admin在2016-10-23 00:59登录了后台', 1, 1477155558),
(46, 1, 1, 2130706433, 'member', 1, 'admin在2016-10-23 01:00登录了后台', 1, 1477155632),
(47, 1, 1, 2130706433, 'member', 1, 'admin在2016-10-23 01:01登录了后台', 1, 1477155669),
(48, 1, 1, 2130706433, 'member', 1, 'admin在2016-10-24 23:08登录了后台', 1, 1477321732);
...
CREATE TABLE IF NOT EXISTS `star_apiconfig` (
...
--
-- 转存表中的数据 `star_apiconfig`
--

INSERT INTO `star_apiconfig` (`id`, `key`, `value`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `star_attribute` (
...
--
-- 转存表中的数据 `star_attribute`
--

INSERT INTO `star_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
...
--
-- 表的结构 `star_auth_extend`
--

CREATE TABLE IF NOT EXISTS `star_auth_extend` (
...
--
-- 转存表中的数据 `star_auth_extend`
--

INSERT INTO `star_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
(1, 1, 1),
(1, 1, 2),
(1, 2, 1),
(1, 2, 2),
...
--
-- 表的结构 `star_auth_group`
--

CREATE TABLE IF NOT EXISTS `star_auth_group` (
...
--
-- 转存表中的数据 `star_auth_group`
--

INSERT INTO `star_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`) VALUES
...
--
-- 表的结构 `star_auth_group_access`
--

CREATE TABLE IF NOT EXISTS `star_auth_group_access` (
...
CREATE TABLE IF NOT EXISTS `star_auth_rule` (
...
--
-- 转存表中的数据 `star_auth_rule`
--

INSERT INTO `star_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`) VALUES
...
CREATE TABLE IF NOT EXISTS `star_buy_user` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL COMMENT '用户ID',
  `name` varchar(100) NOT NULL COMMENT '用户姓名',
  `sex` tinyint(1) NOT NULL DEFAULT '0' COMMENT '性别 0男 1女',
  `old` tinyint(3) NOT NULL COMMENT '年龄',
  `tel` varchar(20) NOT NULL COMMENT '联系电话',
  `address` text NOT NULL COMMENT '联系地址',
  `coordinate` varchar(50) NOT NULL COMMENT '坐标地址 经度,纬度',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid` (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='购买用户表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `star_car` (
  `car_id` int(10) NOT NULL AUTO_INCREMENT,
  `car_num` varchar(20) NOT NULL COMMENT '车牌号',
  `address` varchar(500) NOT NULL COMMENT '派送区域',
  `did` int(10) NOT NULL COMMENT '司机id',
  PRIMARY KEY (`car_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='车辆表' AUTO_INCREMENT=1 ;
...
INSERT INTO `star_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
...
--
-- 表的结构 `star_distribution`
--

CREATE TABLE IF NOT EXISTS `star_distribution` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `orderid` varchar(20) NOT NULL COMMENT '订单号',
  `car_id` int(10) NOT NULL COMMENT '派送车辆ID',
  `coordinate` varchar(50) NOT NULL COMMENT '坐标地址 经度,纬度',
  `time` varchar(15) NOT NULL COMMENT '派送时间',
  `is_over` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否派送完成 0未完成 1已完成',
  PRIMARY KEY (`id`),
  UNIQUE KEY `orderid` (`orderid`,`car_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='配送表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `star_distribution_history`
--

CREATE TABLE IF NOT EXISTS `star_distribution_history` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `car_num` varchar(20) NOT NULL COMMENT '车牌号',
  `run_history` text COMMENT '配送历史路径，json格式，车辆运行轨迹在完成后将会存储于此',
  `ave_speed` varchar(20) DEFAULT NULL COMMENT '平均速度',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='配送历史' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `star_drivers` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '司机ID',
  `name` varchar(30) NOT NULL COMMENT '司机姓名',
  `tel` varchar(20) NOT NULL COMMENT '联系电话',
  `username` varchar(50) NOT NULL COMMENT '登录用户名',
  `pwd` varchar(200) NOT NULL COMMENT '登录密码',
  `remarks` text NOT NULL COMMENT '备注',
  `in_job` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否在职 0在职，1离职',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='司机表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `star_key_value` (
...
--
-- 转存表中的数据 `star_key_value`
--

INSERT INTO `star_key_value` (`id`, `collection`, `uuid`, `name`, `value`) VALUES
(1, 'config.base', 'default', 'web_allow_register', '1'),
(2, 'config.base', 'default', 'web_site_close', '0'),
(3, 'config.base', 'default', 'web_site_description', '小微云商电子商城解决方案'),
(4, 'config.base', 'default', 'web_site_icp', ''),
(5, 'config.base', 'default', 'web_site_keyword', '小微云商 v1.0'),
(6, 'config.base', 'default', 'web_site_title', '小微云商 v1.0'),
...
(25, 'posts.form', '224ac0b6-a569-3d4d-aad4-f96d5cf4869d', 'description', '小微云商1.0正式上线啦，欢迎大家使用！'),
(26, 'posts.cover', '224ac0b6-a569-3d4d-aad4-f96d5cf4869d', 'cover_path_1', '/uploads/picture/20160926/be449a2e369d8b41cb949b2164d89360.jpg'),
(27, 'posts.form', 'effd77f3-b1e0-d78b-3a72-8a02f6cd6aea', 'description', '小微企业正式上线，欢迎使用'),
(28, 'posts.cover', 'effd77f3-b1e0-d78b-3a72-8a02f6cd6aea', 'cover_path_1', '/uploads/picture/20160926/afbdda0ace1ec75a96c343be7753bdba.jpg'),
...
(49, 'users', 'dc5b7d25-3ccc-a790-03e8-5e833655cafb', 'is_root', '1');
...
CREATE TABLE IF NOT EXISTS `star_member` (
...
INSERT INTO `star_member` (`uid`, `nickname`, `sex`, `birthday`, `qq`, `score`, `login`, `reg_ip`, `reg_time`, `last_login_ip`, `last_login_time`, `status`) VALUES
(1, 'admin', 0, '0000-00-00', '', 10, 4, 0, 0, 2130706433, 1477321732, 1);
...
CREATE TABLE IF NOT EXISTS `star_menu` (
...
INSERT INTO `star_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `star_model` (
...
INSERT INTO `star_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `attribute_alias`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`, `engine_type`) VALUES
...
CREATE TABLE IF NOT EXISTS `star_order` (
...
--
-- 表的结构 `star_receiving_address`
--

CREATE TABLE IF NOT EXISTS `star_receiving_address` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL COMMENT '用户ID',
  `name` varchar(100) NOT NULL COMMENT '用户姓名',
  `sex` tinyint(1) NOT NULL DEFAULT '0' COMMENT '性别 0男 1女',
...
--
-- 表的结构 `star_ucenter_admin`
--

CREATE TABLE IF NOT EXISTS `star_ucenter_admin` (
...
--
-- 表的结构 `star_ucenter_app`
--

CREATE TABLE IF NOT EXISTS `star_ucenter_app` (
...
--
-- 表的结构 `star_ucenter_member`
--

CREATE TABLE IF NOT EXISTS `star_ucenter_member` (
...
--
-- 转存表中的数据 `star_ucenter_member`
--

INSERT INTO `star_ucenter_member` (`id`, `username`, `password`, `email`, `mobile`, `reg_time`, `reg_ip`, `last_login_time`, `last_login_ip`, `update_time`, `status`) VALUES
(1, 'admin', 'e2ed39e7a8722e2ffd9002c409a7ba2d', '123@123.com', '', 1476627179, 0, 1476715678, 2130706433, 1476627179, 1);

-- --------------------------------------------------------

--
-- 表的结构 `star_ucenter_setting`
--

CREATE TABLE IF NOT EXISTS `star_ucenter_setting` (
...
CREATE TABLE IF NOT EXISTS `star_votes` (
  ...
  `orderid` varchar(20) NOT NULL COMMENT '订单号',
  `uid` int(10) NOT NULL COMMENT '用户ID',
  `v_content` text NOT NULL COMMENT '评价内容',
  `star` tinyint(1) NOT NULL DEFAULT '0' COMMENT '星级 1-5 5个等级',
  PRIMARY KEY (`id`)
