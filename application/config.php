...
return [
    ...
    'template'              => [
        ...
        'taglib_build_in'   => 'cx,common\taglib\Article,common\taglib\Goods,common\taglib\ExtenTagLib', // 内置标签库名称(标签使用不必指定标签库名称),以逗号分隔 注意解析顺序
    ...
    /* 系统数据加密设置 */
    'DATA_AUTH_KEY' => 'wh/?0(Od1_s=VKY{k.LmI~Av$6Rz]q>,7#;!H*)3', //默认数据加密KEY
